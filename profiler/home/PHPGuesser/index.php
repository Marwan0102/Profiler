...
<head>
    <title>PHPGuesser - Profiler</title>
    <meta charset='utf-8'>
...
<div id="particles-js"></div>
    ...
    <div class="container">
        <div id="main_content">
            <pre>
                ...
                Déjà à l'énigme 4 ! Nous allons voir si vous allez réussir celle-ci.
                Pour cette énigme, pensez à un chiffre entre 0 - 9 avec comme valeur un nombre divisé par lui-même 
                qui donne son double et en paramètre "passwd".
    ...
    if (isset($_GET["passwd"])) {
        if (($_GET['passwd']) == "0.5") {
            echo '<span style="position:relative; color:green;text-align:center;">./md5</span>';
        } else {
            echo '<span style="position:relative; color:red;text-align:center;">Réponse Incorrecte</span>';
        }
    } else {
    }
