...
<div id="particles-js"></div>
    ...
    <div class="container">
        <div id="main_content">
            <pre>
                <center><img src="../img/crying.gif"  alt=""></center>
                Pouvez-vous m'aider, j'ai oublié mon mot de passe et je veux que vous piratiez le site.
                
                <strong>Chemin de connexion :</strong> 
                <em>/login.php?user=profiler&password=123456</em>

                Ceci est mon compte, <a target="_blank" href="index.php?user=supp">cliquez-ici</a>
                </pre>
    ...
    if (isset($_GET["user"])) {
        if ($_GET['user'] == "supp") {
            echo '<center><span style="position:relative; color:red;text-align:center;">', "[$array[2], $array[3]]", '</span></center>';
        } else  {
            echo '<center><span style="position:relative; color:green;text-align:center;">', "[$array[0], $array[1]]", '</span>
        <button class="btn btn-outline-success" onclick="window.location.href=\'../searcher\'">FIN</button></center>';
        }
    } else {
    }
    ?>
