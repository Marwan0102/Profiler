    ...
    <div class="container">
        <div id="main_content">
            <pre>
                ...
                <strong>Given Hash:</strong> 
                Je vois que je vous ai sous-estimé. Maintenant vous allez devoir faire appel à vos 
                talents de décrypteur mais cette épreuve vous retournera le cerveau.
                <em>Pour les prochaines epreuves faites bien attention à votre URL.</em>
                
                <strong><a>c340d8f856d28c665910431b0e043d19</a></strong>
        ...
        if (isset($_POST["guess"])) {
            if ($_POST["guess"] == $answer) {
                echo '<span style="color:green;text-align:center;">../fil3r</span>';
            } else {
        ...
        <form method="POST" action="">
            ...
            <input type="text" class="btn btn-light" name="guess">
