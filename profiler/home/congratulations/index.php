...
<head>
    <title>Congratulations - Profiler</title>
    <meta charset='utf-8'>
...
<body class="default">
    ...
    <div class="container">
        <span id="finish">CONGRATULATIONS</span>
        <div class="container-card">
        <div id="card" class="dark-bg">
            <img id="profile-photo" src="../img/disney.png">

            <div class="contact-wrapper">
                <span>📧 trenise6976@gmail.com<br>🔐 Eugene13</span>
            </div>
        </div>
    </div>
    </div>
